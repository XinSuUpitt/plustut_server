...
let insertClass = (value) => {
  var _sql = `insert into classes set class_name=?, teacher_id=?, price=?, start_time=?, end_time=?, start_date=?, end_date=?, week_day=?, description=?;`
  return query(_sql, value)
}
let updateClass = (value) => {
  var _sql = `update classes set class_name=?, teacher_id=?, price=?, start_time=?, end_time=?, start_date=?, end_date=?, week_day=?, description=? where id=?;`
  return query(_sql, value)
}
