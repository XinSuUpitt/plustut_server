...
let insertClass = (value) => {
  var _sql = `insert into classes set class_name=?, teacher_id=?, price=?, start_time=?, end_time=?, class_date=?, description=?;`
  return query(_sql, value)
}
let updateClass = (value) => {
  var _sql = `update classes set class_name=?, teacher_id=?, price=?, start_time=?, end_time=?, class_date=?, description=? where id=?;`
  return query(_sql, value)
}
